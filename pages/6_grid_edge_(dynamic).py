...
st.markdown('##### As seen in the gifs below, we have expanded the reach of our grid energy usage models into Forsyth and DeKalb, and Gwinnett. (Total population: 3.1 Million+)')
